    ...
    <div className="flex h-screen bg-gray-50">
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <nav className="flex-1 p-3 space-y-1">
            ...
            <Link href="/dashboard/api-usage" className={pathname === "/dashboard/api-usage" ? "bg-indigo-50 text-indigo-700 font-semibold" : "text-gray-600 hover:bg-gray-50"} + " flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-colors"}>API Usage</Link>
